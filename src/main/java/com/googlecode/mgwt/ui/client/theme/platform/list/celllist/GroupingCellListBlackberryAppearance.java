...
public class GroupingCellListBlackberryAppearance extends GroupingCellListAbstractAppearance {
  ...
  interface Resources extends ClientBundle {
    ...
    @Source({"celllist-base.css", "celllist-blackberry.css"})
    CellListCss css();
    
    @Source({"grouping-celllist-base.css", "grouping-celllist-blackberry.css"})
