...
import com.googlecode.mgwt.ui.client.widget.tabbar.TabPanel.TabContainer;
...
public abstract class TabBarAbstractAppearance implements TabBarAppearance {
  ...
  @UiTemplate("TabContainerAbstractAppearance.ui.xml")
  interface ContainerBinder extends UiBinder<Widget, TabPanel.TabContainer> {
  }
  ...
  private static final ContainerBinder UI_BINDER_CONTAINER = GWT.create(ContainerBinder.class);
  ...
  @Override
  public UiBinder<Widget, TabContainer> containerBinder() {
    return UI_BINDER_CONTAINER;
  }
}
