...
public class DialogIPadAppearance extends DialogAbstractAppearance {
  ...
  interface Resources extends ClientBundle {
    ...
    @Source({"dialog-button-base.css", "dialog-button-ipad.css"})
    DialogButtonCss css();
    
    @Source({"dialog-base.css", "dialog-ipad.css"})
    DialogCss cssPanel();
  }
