...
public class GroupingCellListIPhoneAppearance extends GroupingCellListAbstractAppearance {
  ...
  interface Resources extends ClientBundle {
    ...
    @Source({"grouping-celllist-base.css", "grouping-celllist-iphone.css"})
