 ...
 */
public class DefaultOverlayMenuAppearance implements OverlayMenuAppearance {

  private static SwipeMenuUiBinder uiBinder = GWT.create(SwipeMenuUiBinder.class);

  @UiTemplate("DefaultOverlayMenu.ui.xml")
  interface SwipeMenuUiBinder extends UiBinder<Widget, OverlayMenu> {
  }
  ...
  @Override
  public UiBinder<Widget, OverlayMenu> uiBinder() {
    return uiBinder;
  }
