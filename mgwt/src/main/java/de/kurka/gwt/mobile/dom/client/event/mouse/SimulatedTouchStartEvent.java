...
public class SimulatedTouchStartEvent extends TouchStartEvent {
	...
	protected native JsArray<Touch> touches(NativeEvent nativeEvent) /*-{
		...
		touch.pageX = this.@de.kurka.gwt.mobile.dom.client.event.mouse.SimulatedTouchStartEvent::x;
		touch.pageY = this.@de.kurka.gwt.mobile.dom.client.event.mouse.SimulatedTouchStartEvent::y;
