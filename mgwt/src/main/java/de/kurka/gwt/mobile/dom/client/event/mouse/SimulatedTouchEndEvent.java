...
public class SimulatedTouchEndEvent extends TouchEndEvent {
	...
	protected native JsArray<Touch> touches(NativeEvent nativeEvent) /*-{
		...
		touch.pageX = this.@de.kurka.gwt.mobile.dom.client.event.mouse.SimulatedTouchEndEvent::x;
		touch.pageY = this.@de.kurka.gwt.mobile.dom.client.event.mouse.SimulatedTouchEndEvent::y;
